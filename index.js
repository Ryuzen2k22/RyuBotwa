...
/////////////////
const BotName = 'R Y U Z E N BOT☄'; 
const instagram = 'https://instagram.com/ryuzen2k22?igshid=YmMyMTA2M2Y=https://instagram.com/ryuzen2k22?igshid=YmMyMTA2M2Y='; 
const telegram = 'None'; 
const kapanbotaktif = 'KETIKA HANYA GW DIRUMAH'; 
const youtube = 'https://youtube.com/channel/UC7eyb3iyBam8qBYRsTySc2Q';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@Ryuzen2k22')
